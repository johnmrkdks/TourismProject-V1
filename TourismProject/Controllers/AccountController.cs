        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    // Check if the user is an "Agency" or "Tourist" and redirect them accordingly
                    if (await UserManager.IsInRoleAsync(user.Id, "Agency"))
                    {
                        // Redirect to Agencies Dashboard if user is an agency
                        return RedirectToAction("Dashboard", "Agencies");
                    }
                    else if (await UserManager.IsInRoleAsync(user.Id, "Tourist"))
                    {
                        // Redirect to the Home page if user is a tourist
